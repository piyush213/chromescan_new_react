(function ($) {
	...
	$.fn.dataTableExt.oPagination.custompagination = {
		'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
			...
			nPrevious.innerHTML = '<a href="#" aria-controls="' + oSettings.sTableId + '_' + previousClassName + '" class="page-link"><</a>';
			nNext.innerHTML = '<a href="#" aria-controls="' + oSettings.sTableId + '_' + nextClassName + '" class="page-link">></a>';
