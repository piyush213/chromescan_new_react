            ...
            darkMode: function () {
                ...
                $('#darkModaBtn').on('click', function () {
                    ...
                    if ($('body').hasClass('dark-mode')) {                      
                        ...
                        $('#logo-header').attr('src', '/images/logo-white.' + slt +'?v=' + sv);
                        window.mode = 'dark';
                        $("iframe").each(function () {
                            var src = $(this).contents().find('body');
                            src.addClass('dark-mode');
                            //src.attr('style', 'background: #212121 !important;');
                            ...
                            if (subIframe.length > 0) {
                                ...
                                var style = 'background: #212121 !important;';
                        ...
                        $('#logo-header').attr('src', '/images/logo.' + slt +'?v=' + sv);        
                        window.mode = 'normal';
                        $("iframe").each(function () {
                            var src = $(this).contents().find('body');
