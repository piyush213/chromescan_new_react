          ...
          <main id="content" role="main">
            <div className="container">
              <div className="d-md-flex justify-content-between align-items-center border-bottom py-3">
                <div className="mb-1 mb-md-0">
                  <h1 className="h4 mb-0"><span className="d-block">Chromescan Unique Addresses Chart</span></h1>
                </div>
                <nav id="ContentPlaceHolder1_breadcrumb" aria-label="breadcrumb">
                  <ol className="breadcrumb small p-0 mb-0">
                    ...
                    <li className="breadcrumb-item active">Chromescan Unique Addresses Chart</li>
                  </ol>
                </nav>
              </div>
            </div>
            <div className="container">
              <div className="card mt-3 mb-4">
                <div className="card-body"><span>The chart shows the total distinct numbers of address on the Chromescan and the increase in the number of address daily.</span></div>
              </div>
              <div className="card mb-2">
                <div className="card-body">
                  <div className="row">
                    <div className="col-md-6 text-center">
                      <p className="mt-2 mb-2"><i className="fa fa-lightbulb mr-2" /> Highest increase of  <b>40,664</b>  new addresses was recorded on Tuesday, April 12, 2022</p>
                    ...
                    <div className="col-md-6 text-center u-ver-divider u-ver-divider--left u-ver-divider--none-md">
                      <p className="mt-2 mb-2"><i className="fa fa-lightbulb mr-2" /> Lowest increase of  <b>376</b>  new addresses was recorded on Saturday, March 25, 2023</p>
                    </div>
                  </div>
                </div>
              </div>
